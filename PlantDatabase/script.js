...
const allTags = {
  ...
  "FRUITS":["Berries","Cones","Fleshy fruits","Nuts","Samaras"],
  ...
  "PLANT WARNINGS": ["Allergenic","Invasive roots","Needs wind shelter","Not pet safe","Toxic","Skin irritant","Susceptible to frost","Susceptible to frost (when small)"],
