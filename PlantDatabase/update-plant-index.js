...
const allTagKeys = [
  "FAMILY", "TYPE OF PLANT", "FLOWER COLOUR", "FLOWER SHAPE", "FLOWERING PERIOD",
  "VALUE FOR INSECTS", "FRUITS", "FRUITING PERIOD", "EDIBLE", "LEAF COLOUR",
  "AUTUMN COLOURS", "WINTER ASPECT", "SPECIAL FEATURES", "PLANT WARNINGS",
  "HEIGHT", "WIDTH", "GROWTH RATE", "USE", "HABITAT", "ORIGIN TO BELGIUM",
  "HARDINESS ZONE (BE 7-8)", "SUNLIGHT", "GROUND TYPE", "SOIL DRAINAGE",
  "SOIL MOISTURE", "SOIL PH", "ACCESSIBILITY", "PLANTING DENSITY",
  "SCHOOL SUBJECT"
];
