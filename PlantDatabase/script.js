...
const allTags = {
  ...
  "INDIVIDUAL FLOWER SHAPE": ["Bell flowers","Cup flowers","Spathe-and-spadix","Star flowers","Tubular flowers","Inconspicuous flowers","Other flower shapes"],
  "FLOWER CLUSTER SHAPE": ["Ball flower clusters","Daisy flowers","Flat flower clusters","Hanging flower clusters","Panicle flower clusters","Small flower clusters","Spike flower clusters","Catkins","Other flower clusters"], 
  ...
  "SPECIAL FEATURES": ["Decorative bark","Large leaves","Deciduous winter interests","Luminescent","Thorns","Tropical look"],
