...
const allTagKeys = ["TYPE OF PLANT","LEAF COLOR","VARIEGATION COLOR","VARIEGATION TYPE","FLOWER COLOR","GROWTH TYPE","HEIGHT (excl. climbing)","WIDTH (excl. climbing)","LEAF SIZE (Maximum)","LEAF TEXTURE","SPECIAL FEATURES","LIGHT","WATERING","SUBSTRATE","NUTRIENTS","RELATIVE HUMIDITY","TEMPERATURE","ORIGIN","HABITAT","ORIGIN STATUS","GROWTH RATE","RARITY","DIFFICULTY","NOTE"];
